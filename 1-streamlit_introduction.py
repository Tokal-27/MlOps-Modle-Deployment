...
st.title("Machine Learning Model Deployment  Server")

# header
st.header("Omar tokal & youssef emad project")

# subheading
st.subheader("This is subheader")

# text data
st.text("Deployment of Machine Learning Model at Streamlit Server")
